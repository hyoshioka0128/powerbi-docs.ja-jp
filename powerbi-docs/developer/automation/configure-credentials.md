---
title: 埋め込み BI 分析情報を向上させるため、Power BI 埋め込み分析の資格情報をプログラムで構成する
description: Power BI を自動化する場合に資格情報をプログラムで構成する方法。 Power BI 埋め込み分析を使用して、より優れた埋め込み BI インサイトを有効にします。
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
