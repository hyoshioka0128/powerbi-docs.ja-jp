...
ms.openlocfilehash: 6ca3c6197f4580b5516e090baaaa5465cdc953c3
ms.sourcegitcommit: 7727a56e54e2f50098106c6d7454b725ed6baa19
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 03/20/2021
ms.locfileid: "104725414"
---
...
5. **[EndDate]** を **[このページでのフィルター]** の上にドラッグし、 **[基本フィルター]** で **[(空白)]** のチェックボックスのみを選択します。
...
8. **[成功]** 画面で、**[Power BI で 'AdventureWorksProducts.pbix' を開く]** を選択します。
    ...
    [Power BI に発行する](./media/service-gateway-sql-tutorial/publish-to-power-bi.png)
...
## <a name="perform-an-on-demand-refresh"></a>オンデマンド更新の実行
