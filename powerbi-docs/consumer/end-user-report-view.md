...
![[表示] のドロップダウン オプションのスクリーンショット。](media/end-user-report-view/power-bi-menu-view.png)
...
![ブラウザーのズーム コントロール](media/end-user-report-view/power-bi-zoom.png)
