...
ms.topic: conceptual
ms.date: 11/05/2018
ms.openlocfilehash: f8d5b9369a930bdea22784c54542c1cddabccf17
ms.sourcegitcommit: 48d8aa293669fa881d682d5279e2d51cba342bd0
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 04/01/2021
ms.locfileid: "106104419"
---
...
[詳細については、レポート パラメーターに関する記事を参照してください](paginated-reports-parameters.md)   
...
## <a name="5-grouping-pane"></a>5 [グループ化] ペイン
 ...
 詳細については、[グループ化ペインおよびグループの概要](../create-reports/desktop-grouping-visuals.md)に関する記事を参照してください。  
