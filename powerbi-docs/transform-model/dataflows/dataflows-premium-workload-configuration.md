...
2. フォールドする操作 (結合、結合、変換、および[その他](https://docs.microsoft.com/power-query/power-query-folding#transformations-that-can-achieve-folding)の操作など) を確実に実行してください。
