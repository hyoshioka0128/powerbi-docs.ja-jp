...
![レポート キャンバスのスクリーンショット。Power B I Desktop レポートでグリッド線と "グリッドにスナップ" を使用する方法を示しています。](media/desktop-gridlines-snap-to-grid/snap-to-grid_0.png)
...
![レポート キャンバスのスクリーンショット。Power B I Desktop レポートでグリッド線と "グリッドにスナップ" を有効にする方法を示しています。](media/desktop-gridlines-snap-to-grid/snap-to-grid_1.png)
...
![レポート キャンバスのスクリーンショット。レポート内のビジュアルの前面から背面への順序を管理する方法を示しています。](media/desktop-gridlines-snap-to-grid/snap-to-grid_4.png)

**[書式]** リボンではさまざまな方法でビジュアルを揃えることができ、ページ上のビジュアルを最適な外観と動作に配置できます。

![レポート キャンバスのスクリーンショット。さまざまな方法でビジュアルを配置する方法を示しています。](media/desktop-gridlines-snap-to-grid/snap-to-grid_5.png)

次の図に示すように、 **[配置]** ボタンは、レポート キャンバスの端 (または中央) に選択したビジュアルを配置します。

![レポート キャンバスのスクリーンショット。[配置] ボタンを使用し、選択したビジュアルをキャンバスの端 (または中央) に配置します。](media/desktop-gridlines-snap-to-grid/snap-to-grid_6.png)

複数のビジュアルを選ぶと、まとめて配置され、配置には既に配置されているビジュアルの境界が使われます。 たとえば、2 つのビジュアルを選んで **[左揃え]** オプションを選ぶと、ビジュアルは選択したすべてのビジュアルのうち左端の境界に揃えられます。

![レポート キャンバスのスクリーンショット。[左揃え] オプションを使用して 2 つのビジュアルを揃える方法を示しています。](media/desktop-gridlines-snap-to-grid/snap-to-grid_7.png)

レポート キャンバスの全体に、ビジュアルを縦または横に整列することもできます。 それには、 **[書式]** リボンの **[整列]** ボタンを使います。

![レポート キャンバスのスクリーンショット。[整列] オプションを使用し、キャンバス全体で均等にビジュアルを配置する方法を示しています。](media/desktop-gridlines-snap-to-grid/snap-to-grid_8.png)
