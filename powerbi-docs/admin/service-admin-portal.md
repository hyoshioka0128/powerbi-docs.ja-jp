...
後続のセクションでは、 **[テナント設定]** タブの設定について説明します。
...
組織内のユーザーは Power BI サービスの Live Connect を使用できます。 ライブ接続を許可すると、ユーザーは [Excel で分析] も許可されます。
