...
![[利用状況データを送信する] の [オプション] 設定のスクリーンショット。](media/desktop-privacy/privacy_01.png)
...
![問題を報告するか、閉じるかを選択する、クラッシュ ダイアログのスクリーンショット。](media/desktop-privacy/privacy_02.png)
