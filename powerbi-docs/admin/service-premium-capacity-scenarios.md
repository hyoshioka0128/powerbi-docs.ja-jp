...
このシナリオでは、レポートのビジュアルの応答が遅くなったり、応答しなくなったりする場合があることをユーザーが説明したことで、調査が開始されました。 それ以外のときは、レポートのビジュアルの応答性は許容範囲内です。
...
> [!NOTE]
> Premium Gen2 および [Embedded Gen2](../developer/embedded/power-bi-embedded-generation-2.md) の場合、メモリ消費量を追跡する必要はありません。 Premium Gen2 および Embedded Gen2 で制限されるのは、1 つの成果物のメモリ占有領域のみです。 メモリ占有領域は、その容量で使用可能なメモリを超えることはできません。 Premium Gen2 の詳細については、[Power BI Premium Generation 2 (プレビュー)](service-premium-what-is.md#power-bi-premium-generation-2-preview) に関する記事を参照してください。
...
> [!NOTE]
> Premium Gen2 および [Embedded Gen2](../developer/embedded/power-bi-embedded-generation-2.md) の場合は、CPU 時間使用率が成果物ごとのレベルで追跡され、容量使用率アプリに表示されます。 各成果物には、特定の期間での合計 CPU 時間使用率が表示されます。 Premium Gen2 の詳細については、[Power BI Premium Generation 2 (プレビュー)](service-premium-what-is.md#power-bi-premium-generation-2-preview) に関する記事を参照してください。
